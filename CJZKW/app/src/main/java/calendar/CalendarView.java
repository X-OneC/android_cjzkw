 ...
 *
 * @author 还如一梦中
 * @version v1.0 @date：2013-8-23 下午2:03:29
 */
public class CalendarView extends LinearLayout {
	...
	public CalendarView(Context context, AttributeSet attrs) {
		...
		layoutParamsFW = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
		this.setOrientation(LinearLayout.VERTICAL);
		this.setBackgroundColor(Color.rgb(238, 238, 238));
		...
		float ratioHeight = (float) height / 1136;
		float RATIO = Math.min(ratioWidth, ratioHeight);
		mLinearLayoutHeader = new LinearLayout(context);
		mLinearLayoutHeader.setLayoutParams(new LayoutParams(width - 44, headerHeight));
		mLinearLayoutHeader.setOrientation(LinearLayout.VERTICAL);
		mCalendarHeader = new CalendarHeader(context);
		mCalendarHeader.setLayoutParams(new LayoutParams(width - 44, headerHeight));
		mLinearLayoutHeader.addView(mCalendarHeader,
				new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
		mLinearLayoutHeader.setBackgroundColor(getResources().getColor(R.color.transparent));
		...
		mLinearLayoutContent.setBackgroundColor(getResources().getColor(R.color.transparent));
		addView(mLinearLayoutContent);

		cellWidth = (width - Math.round(40 * RATIO)) / 7;
		rowHeight = cellWidth - Math.round(30 * RATIO);
	...
	public void initRow() {
		...
		for (int iRow = 0; iRow < 6; iRow++) {
			...
			mLinearLayoutRow.setLayoutParams(new LayoutParams(width - 44, rowHeight));
			mLinearLayoutRow.setOrientation(LinearLayout.HORIZONTAL);
			mLinearLayoutRow.setBackgroundColor(getResources().getColor(R.color.transparent));
